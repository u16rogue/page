...
<div class="main">
    <div class="left">
        <img class="profile-image" src="https://avatars.githubusercontent.com/u/61908580?v=4" alt="profile picture">
    </div>
    <div class="right">
        <h1>info</h1>
        <p style="font-size: 2rem;">🐀, 7️⃣ 🐇, ⛩️🥒</p>
        <p><span class="item-list-highlighter">Time Zone:</span> ?</p>
        <p><span class="item-list-highlighter">Languages:</span> ?</p>

        <h1>identifiers</h1>
        <p><span class="item-list-highlighter">GPG Keys:</span></p>
        <ul>
            <li>u16rogue: <a href="https://keys.openpgp.org/search?q=C9B398C05E5DE967E42B9427E2B4C1A73AF65CBF">OpenPGP</a></li>
        </ul>
        ...
        <p><span class="item-list-highlighter">Email:</span> <a href="mailto:contact@ushort.moe">contact@ushort.moe</a></p>
